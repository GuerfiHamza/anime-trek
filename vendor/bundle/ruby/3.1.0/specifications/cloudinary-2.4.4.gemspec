# -*- encoding: utf-8 -*-
# stub: cloudinary 2.4.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<faraday-follow_redirects>.freeze, ["~> 0.5"])
    s.add_dependency(%q<ostruct>.freeze, [">= 0"])
    s.add_dependency(%q<rails>.freeze, [">= 6.1.7", "< 9.0.0"])
    s.add_dependency(%q<rexml>.freeze, [">= 3.2.5", "< 4.0.0"])
    s.add_dependency(%q<actionpack>.freeze, [">= 6.1.7", "< 9.0.0"])
    ...
    s.add_dependency(%q<railties>.freeze, [">= 6.0.4", "< 9.0.0"])
    s.add_dependency(%q<rspec-rails>.freeze, [">= 6.0.4", "< 9.0.0"])
